...
<input type="hidden" name="_token" value="{{csrf_token()}}">-->
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" value="{{$student->name}}" name="name" id="firstname" 
				   placeholder="请输入品牌名称">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="number" class="form-control" value="{{$student->age}}" name="age" id="lastname" >
		</div>
	</div>
        <div class="form-group">
